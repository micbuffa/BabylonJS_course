export default class Dude {
  constructor(dudeMesh, id, speed, scaling, scene) {
    ...
    if (Dude.particleSystem == undefined) {
      Dude.particleSystem = this.createParticleSystem(scene);
    }
*/
    this.particleSystem = this.createParticleSystem(scene);
  ...
  move(scene) {
    ...
    this.particleSystem.emitter = new BABYLON.Vector3(this.bounder.position.x, this.bounder.position.y+10, this.bounder.position.z);
